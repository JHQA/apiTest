...
class TestTrades(unittest.TestCase):
    ...
    def test_bitfinex_btcusd_trades(self):
        ...
        self.assertEqual(len(jsonData), 5, 'bitfinex/btcusd trades is missing data')
    ...
    def test_bitfinex_ltcusd_trades(self):
        ...
        self.assertEqual(len(jsonData), 5, 'bitfinex/ltcusd trades is missing data')
    ...
    def test_bitfinex_ltcbtc_trades(self):
        ...
        self.assertEqual(len(jsonData), 5, 'bitfinex/ltcbtc trades is missing data')
    ...
    def test_bitfinex_ethusd_trades(self):
        ...
        self.assertEqual(len(jsonData), 5, 'bitfinex/ethusd trades is missing data')
    ...
    def test_bitfinex_ethbtc_trades(self):
        ...
        self.assertEqual(len(jsonData), 5, 'bitfinex/ethbtc trades is missing data')
