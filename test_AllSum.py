...
class TestAllSum(unittest.TestCase):
    ...
    def test_summaries_status(self):
    ...
    def test_summaries_headers(self):
        self.assertEqual(resp.headers.get('Content-Type'), 'application/json', ' The wrong header content-type appears /markets/summaries')

    # Verify bitfinex/btcusd summary has the correct info
    def test_summaries_btcusd(self):
    ...
    def test_summaries_ethbtc(self):
    ...
    def test_summaries_ethusd(self):
    ...
    def test_summaries_ltcbtc(self):
    ...
    def test_summaries_ltcusd(self):
    ...
    # Verify cursor data
    def test_summaries_cursor(self):
    ...
    def test_summaries_allowance(self):
