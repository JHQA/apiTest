...
class TestPrices(unittest.TestCase):
    ...
    def test_bitfinex_btcusd_ohlc(self):
        ...
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][0]), '/bitfinex/btcusd/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][1]), '/bitfinex/btcusd/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][2]), '/bitfinex/btcusd/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][3]), '/bitfinex/btcusd/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][4]), '/bitfinex/btcusd/ohlc did not return a of numbers')
    ...
    def test_bitfinex_ltcusd_ohlc(self):
        ...
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][0]), '/bitfinex/ltcusd/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][1]), '/bitfinex/ltcusd/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][2]), '/bitfinex/ltcusd/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][3]), '/bitfinex/ltcusd/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][4]), '/bitfinex/ltcusd/ohlc did not return a of numbers')
    ...
    def test_bitfinex_ltcbtc_ohlc(self):
        ...
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][0]), '/bitfinex/ltcbtc/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][1]), '/bitfinex/ltcbtc/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][2]), '/bitfinex/ltcbtc/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][3]), '/bitfinex/ltcbtc/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][4]), '/bitfinex/ltcbtc/ohlc did not return a of numbers')
    ...
    def test_bitfinex_ethusd_ohlc(self):
        ...
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][0]), '/bitfinex/ethusd/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][1]), '/bitfinex/ethusd/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][2]), '/bitfinex/ethusd/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][3]), '/bitfinex/ethusd/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][4]), '/bitfinex/ethusd/ohlc did not return a of numbers')
    ...
    def test_bitfinex_ethbtc_ohlc(self):
        ...
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][0]), '/bitfinex/ethbtc/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][1]), '/bitfinex/ethbtc/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][2]), '/bitfinex/ethbtc/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][3]), '/bitfinex/ethbtc/ohlc did not return a of numbers')
        self.assertTrue(all(isinstance(item, (int, float)) for item in jsonData['14400'][4]), '/bitfinex/ethbtc/ohlc did not return a of numbers')
